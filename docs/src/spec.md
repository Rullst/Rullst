...
### v13 active-session management (increment under development)
...
Source/package and final release admission remain separate pending gates.
...
in [the Redis messaging guide](redis-messaging.md). Hosted source/package and
final release admission remain pending.
...
### 4.4. Private S3-compatible storage (v13 increment under development)
...
provider configuration or regional legal compliance. Source and release
admission remain pending until their respective checks pass.
