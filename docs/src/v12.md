...
RC é agora **cerca de 82,8%: 17,2% permanece**. Essa estimativa inclui elevar cada
...
aplicáveis ficarem verdes e não é sinônimo dos 17,2% de prontidão operacional
restantes.
...
A estimativa de 82,8% usa uma régua explícita de planejamento, distinta do
scorecard:
...
| Gates repetidos no SHA final | 20% | 70% | 14,0% | Cobertura e 20 workflows passaram no candidato; a correção Windows local, os testes pesados e a repetição no SHA final permanecem |
| Versões, pacotes e documentação da prerelease | 15% | 65% | 9,8% | Documentação e links passaram na auditoria local; faltam bump `rc.1`, pacote/consumidor exatos e revisão semântica final |
...
| **Total** | **100%** | — | **82,8%** | **17,2% operacional permanece** |
