...
gate em sua seção detalhada e no resumo da versão estável. No scorecard, Core e
ORM já estão em A, IoT já satisfaz a exceção B e treze crates ainda precisam
subir para A, numa lacuna agregada de 67 pontos auditáveis. A
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  IoT tem 83/B; treze crates ainda estão abaixo de A, somando 67 pontos de
  lacuna até seus pisos. O gate permanece aberto até implementação real e até
  o artefato do SHA candidato comprovar todos os gates condicionantes.
