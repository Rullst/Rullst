...
ORM, Security, Connect, AI e a facade `rullst` já estão em A, IoT satisfaz a exceção
B e nove crates ainda precisam subir para A, numa lacuna agregada de 56 pontos
até os pisos. A
...
para no piso: os tetos locais provisionais somam 1.514/1.600, contra 1.379
pontos já auditados, deixando **135 pontos de evidência**. A distância
matemática ao teto é 8,9%, mas concentra o trabalho mais caro e por isso não é
...
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 91,1% | 50,1% | 1.379/1.514 pontos atuais; faltam os clusters de integração/operação da tabela de qualidade |
...
| **Total** | **100%** | — | **65,9%** | **34,1% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  ORM têm 91/A, Security, Connect, AI e a facade `rullst` têm 90/A, e IoT tem 83/B;
  nove crates estão abaixo de A, somando 56 pontos de lacuna até os pisos. Esses
