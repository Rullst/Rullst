...
RC é agora **cerca de 68,7%: 31,3% permanece**. Essa estimativa inclui elevar cada
...
totalizam 1.509/1.600, contra 1.452 pontos já auditados, deixando **57 pontos de
evidência**. A distância matemática ao alvo é 3,8%, mas concentra o trabalho
mais caro e por isso não é usada como sinônimo dos 31,3% de prontidão
...
A estimativa de 68,7% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 96,2% | 52,9% | 1.452/1.509 pontos atuais; faltam os clusters de integração/operação das 15 crates não-IoT |
...
| **Total** | **100%** | — | **68,7%** | **31,3% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  IoT tem 83/B. Capital subiu a 89/B com o ledger relacional de webhook;
  Capital, Studio e cargo-rullst continuam abaixo de A, somando 13 pontos de
  lacuna até os pisos. Esses valores são tetos **atuais**, não metas finais: a campanha v12 pretende
