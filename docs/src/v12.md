...
RC é agora **cerca de 66%: 34% permanece**. Essa estimativa inclui elevar cada
...
ORM, Security, Connect, Auth, AI e a facade `rullst` já estão em A, IoT satisfaz a exceção
B e oito crates ainda precisam subir para A, numa lacuna agregada de 53 pontos
até os pisos. A
...
para no piso: os tetos locais provisionais somam 1.514/1.600, contra 1.387
pontos já auditados, deixando **127 pontos de evidência**. A distância
matemática ao teto é 8,4%, mas concentra o trabalho mais caro e por isso não é
usada como sinônimo dos 34% de prontidão operacional restantes.
...
A estimativa de 66% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 91,6% | 50,4% | 1.387/1.514 pontos atuais; faltam os clusters de integração/operação da tabela de qualidade |
...
| **Total** | **100%** | — | **66,2%** | **33,8% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  e IoT tem 83/B; oito crates estão abaixo de A, somando 53 pontos de lacuna até
