...
RC é agora **cerca de 68,8%: 31,2% permanece**. Essa estimativa inclui elevar cada
...
crates de macros e a facade `rullst` já estão em A, IoT satisfaz a exceção B e
duas crates ainda precisam subir para A, numa lacuna agregada de 12 pontos
até os pisos. A
...
totalizam 1.509/1.600, contra 1.455 pontos já auditados, deixando **54 pontos de
evidência**. A distância matemática ao alvo é 3,6%, mas concentra o trabalho
mais caro e por isso não é usada como sinônimo dos 31,2% de prontidão
operacional restantes.

Com o ritmo observado nos lotes delimitados recentes, a previsão responsável é
**14–24 dias de trabalho efetivo** para alcançar os tetos locais, corrigir as
...
seria aproximadamente 5–10 dias; essa alternativa não é o objetivo atual.

A estimativa de 68,8% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 96,4% | 53,0% | 1.455/1.509 pontos atuais; faltam os clusters de integração/operação das 15 crates não-IoT |
...
| **Total** | **100%** | — | **68,8%** | **31,2% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  IoT tem 83/B. Capital subiu a 92/A com o ledger relacional de webhook e o
  contrato compartilhado de egress/falhas dos gateways; Studio e cargo-rullst
  continuam abaixo de A, somando 12 pontos de lacuna até os pisos. Esses
...
elevou Capital de 89/B para **92/A**; o último ponto até o teto 93/A permanece no
cluster fiscal local de auditoria/recovery, sem inventar autorização ou
homologação SEFIN.
