...
- [ ] Doc tests, Wasm/no_std, E2E, benchmarks, fuzzing delimitado, Miri, Kani,
  ...
  corpus, e os alvos de redator e sanitizer passaram 100.000 execuções cada com
  libFuzzer/AddressSanitizer em 2026-09-05. A campanha completa ainda precisa
  passar novamente no SHA final, portanto o item permanece aberto.
