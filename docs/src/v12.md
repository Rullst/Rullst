...
RC é agora **cerca de 69,3%: 30,7% permanece**. Essa estimativa inclui elevar cada
...
crates de macros, `cargo-rullst` e a facade `rullst` já estão em A, IoT satisfaz
a exceção B e somente Studio ainda precisa subir para A, numa lacuna de 7 pontos
até os pisos. A
...
totalizam 1.509/1.600, contra 1.466 pontos já auditados, deixando **43 pontos de
evidência**. A distância matemática ao alvo é 2,8%, mas concentra o trabalho
mais caro e por isso não é usada como sinônimo dos 30,7% de prontidão
operacional restantes.

Com o ritmo observado nos lotes delimitados recentes, a previsão responsável é
**12–22 dias de trabalho efetivo** para alcançar os tetos locais, corrigir as
...
seria aproximadamente 3–7 dias; essa alternativa não é o objetivo atual.

A estimativa de 69,3% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 97,2% | 53,5% | 1.466/1.509 pontos atuais; faltam os clusters de integração/operação das sete crates não-IoT restantes |
...
| **Total** | **100%** | — | **69,3%** | **30,7% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  e rejeição de symlink. Somente Studio continua abaixo de A, com 7 pontos de
  lacuna até o piso. Esses
