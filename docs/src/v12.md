...
ainda precisam subir para A, numa lacuna agregada de 60 pontos até os pisos. A
...
para no piso: os tetos locais provisionais somam 1.514/1.600, contra 1.375
pontos já auditados, deixando **139 pontos de evidência**. A distância
matemática ao teto é 9,2%, mas concentra o trabalho mais caro e por isso não é
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  abaixo de A, somando 60 pontos de lacuna até os pisos. Esses valores são
