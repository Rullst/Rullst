...
exceto IoT/B, a estimativa preliminar de engenharia preparatória da RC voltou a
**cerca de 65–70%**. Ela será recalculada após a auditoria crate a crate e
continua condicionada aos demais P0 e à evidência externa no SHA final.
...
ORM e Security já estão em A, IoT satisfaz a exceção B e doze crates ainda
precisam subir para A, numa lacuna agregada de 66 pontos auditáveis. A
[tabela de qualidade](quality-scorecard.md#measured-gap-to-the-v12-quality-gate)
registra cada distância sem tratá-la como quantidade de tarefas.
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  publicado quando a evidência objetiva alcançar 97. Core e ORM têm teto 91/A,
  Security tem 90/A e IoT tem 83/B; doze crates ainda estão abaixo de A,
  somando 66 pontos de lacuna até seus pisos. O gate permanece aberto até haver
