...
totalizam 1.509/1.600, contra 1.503 pontos já auditados, deixando **6 pontos de
evidência**. A distância matemática ao alvo é 0,4%, mas concentra trabalho de
integração da facade e por isso não é usada como sinônimo dos 29,4% de prontidão
operacional restantes.

Com o ritmo observado nos lotes delimitados recentes, a previsão responsável é
**5–14 dias de trabalho efetivo** para fechar a facade, elevar o novo
...
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 99,6% | 54,8% | 1.503/1.509 pontos atuais; falta o cluster de composição/recuperação da facade não-IoT |
...
| **Total** | **100%** | — | **70,6%** | **29,4% operacional permanece** |
