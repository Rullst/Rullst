...
RC é agora **cerca de 68,9%: 31,1% permanece**. Essa estimativa inclui elevar cada
...
totalizam 1.509/1.600, contra 1.456 pontos já auditados, deixando **53 pontos de
evidência**. A distância matemática ao alvo é 3,5%, mas concentra o trabalho
mais caro e por isso não é usada como sinônimo dos 31,1% de prontidão
...
A estimativa de 68,9% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 96,5% | 53,1% | 1.456/1.509 pontos atuais; faltam os clusters de integração/operação das 15 crates não-IoT |
...
| **Total** | **100%** | — | **68,9%** | **31,1% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  fiscal local autenticado; Studio e cargo-rullst
