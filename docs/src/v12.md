...
> **Status em 2 de setembro de 2026:** programa de trabalho auditável, não
...
RC é agora **cerca de 67,3%: 32,7% permanece**. Essa estimativa inclui elevar cada
...
ORM, Security, Connect, Auth, Mail, Messaging, AI, Nexus e a facade `rullst` já
estão em A, IoT satisfaz a exceção B e cinco crates ainda precisam subir para A,
numa lacuna agregada de 37 pontos
até os pisos. A
...
para no piso: os tetos locais provisionais somam 1.514/1.600, contra 1.419
pontos já auditados, deixando **95 pontos de evidência**. A distância
matemática ao teto é 6,3%, mas concentra o trabalho mais caro e por isso não é
usada como sinônimo dos 32,7% de prontidão operacional restantes.

Com o ritmo observado nos lotes delimitados recentes, a previsão responsável é
**17–29 dias de trabalho efetivo** para alcançar os tetos locais, corrigir as
...
seria aproximadamente 9–16 dias; essa alternativa não é o objetivo atual.

A estimativa de 67,3% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 93,7% | 51,5% | 1.419/1.514 pontos atuais; faltam os clusters de integração/operação da tabela de qualidade |
...
| **Total** | **100%** | — | **67,3%** | **32,7% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  ORM têm 91/A, Auth, Mail e Nexus têm 95/A, Messaging tem 96/A, Security,
  Connect, AI e a facade `rullst` têm 90/A, e IoT tem 83/B; cinco crates estão
  abaixo de A, somando 37 pontos de lacuna até
  os pisos. Esses valores são tetos **atuais**, não metas finais: a campanha v12 pretende
  alcançar os tetos locais provisionais documentados no scorecard (93–96/A nas
  demais crates e 88/B em IoT), sem fabricar os pontos que dependem de hardware,
...
arquivo allowlisted e URL sob egress policy leva o estado atual a **105
integrais, 83 parciais e 2 ausentes**: **55,3% estrito** ou **77,1% ponderado**.
