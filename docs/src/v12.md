...
seu escopo. A [baseline oficial mais recente](https://app.codecov.io/gh/Rullst/Rullst/commit/04006e82d47dc3821bb3b99554ff8184e9be8cef),
publicada pelo Codecov para o SHA `04006e82` em 2026-09-01, é:
...
mais 2.811 linhas existentes para alcançar 90%; esse número muda quando código
...
- [x] Configurar um único gate de **≥90% de line coverage nas bibliotecas do
  framework** para RC e estável, sem tolerância. A baseline oficial de 84,40%
