...
- [ ] [!] Concluir a auditoria documental da RC: o `mdbook build` já passa e o
  ...
  informativa. Os 52 tutoriais contêm exatamente 106 blocos Rust: o novo harness
  Cargo-aware compilou/executou 88 e os 18 `ignore` restantes agora declaram a
  ...
  completo contém 200 blocos Rust; portanto ainda é necessário terminar a
  classificação semântica dos 94 blocos fora dos tutoriais e reexecutar tudo no
