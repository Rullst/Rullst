...
RC é agora **cerca de 68,5%: 31,5% permanece**. Essa estimativa inclui elevar cada
...
ORM, Security, Connect, Auth, Mail, Messaging, AI, Nexus, as duas crates de
macros e a facade `rullst` já estão em A, IoT satisfaz a exceção B e três crates
ainda precisam subir para A, numa lacuna agregada de 20 pontos
até os pisos. A
...
totalizam 1.509/1.600, contra 1.445 pontos já auditados, deixando **64 pontos de
evidência**. A distância matemática ao alvo é 4,2%, mas concentra o trabalho
mais caro e por isso não é usada como sinônimo dos 31,5% de prontidão
...
A estimativa de 68,5% usa uma régua explícita de planejamento, distinta do
scorecard:

| Frente da RC | Peso | Estado estimado | Contribuição | Evidência/pendência dominante |
| :--- | ---: | ---: | ---: | :--- |
| Campanha de qualidade até os tetos locais | 55% | 95,8% | 52,7% | 1.445/1.509 pontos atuais; faltam os clusters de integração/operação das 15 crates não-IoT |
...
| **Total** | **100%** | — | **68,5%** | **31,5% operacional permanece** |
...
- [ ] [!] Scorecard no SHA da RC com **A (90) ou mais em todas as crates**, salvo
  ...
  IoT tem 83/B; três crates estão abaixo de A, somando 20 pontos de lacuna até
