...
- [x] Configurar um único gate de **≥90% de line coverage nas bibliotecas do
  framework** para RC e estável, sem tolerância. A baseline local registrada de
  83,81% e o agregado público anterior ainda ficam abaixo dessa política; falta
  elevar a suíte e comprová-la no SHA da RC.
