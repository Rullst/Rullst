...
2. **Execuções focadas registradas durante o hardening**: Connect, AI, Mail,
   ...
   validou 270 combinações e os três projetos representativos passaram checks
   Cargo offline.
