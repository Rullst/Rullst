...
3. **Tríade local final reexecutada em 2026-08-27**, com Rust/Cargo 1.98.0:

```text
cargo test --workspace --all-features -j 1                                PASS
...
por driver. A dependência do Swagger UI foi posteriormente alterada para o
bundle vendorizado, removendo o download GitHub/DNS durante builds limpos.
