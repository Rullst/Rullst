...
| **4.7 Alinhar RC/changelog/tag/crates/release notes** | **Aprovado; publicação pendente** | Os 16 manifests publicáveis e requisitos internos estão sincronizados em `12.0.0-rc.1`, e o preflight rejeita tag ou grafo divergente. [`CHANGELOG.md`](../../CHANGELOG.md) registra a data da RC; `a6b3bc8a` passou os gates de código, distribuição e alertas, e o proprietário concedeu GO em 2026-09-12. Tag, crates.io e release notes continuam sem evidência até o workflow protegido concluir. |
