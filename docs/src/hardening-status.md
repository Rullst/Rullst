...
| **4.7 Alinhar RC/changelog/tag/crates/release notes** | **Parcial** | Os 16 manifests publicáveis e requisitos internos do worktree de preparação estão sincronizados em `12.0.0-rc.1`, e o preflight rejeita tag ou grafo divergente. [`CHANGELOG.md`](../../CHANGELOG.md) marca corretamente a RC como Unreleased; o `HEAD` ainda não é o commit limpo aprovado, não possui a tag exata e crates.io/release notes permanecem sem evidência até a publicação. |
