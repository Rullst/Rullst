...
| **Codecov — whole repository** | [![Whole-repository coverage](https://codecov.io/github/Rullst/Rullst/branch/main/graph/badge.svg)](https://codecov.io/gh/Rullst/Rullst) | The badge and link both report the current complete public aggregate. The v12 RC target is **≥90%** with zero tolerance; the dated baseline and remaining gap are tracked in the [v12 release plan](docs/src/v12.md#4-cobertura-e-qualidade-dos-testes). |
