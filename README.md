...
| **Fuzz Corpus Minimization** | [![Corpus Sync](https://img.shields.io/github/actions/workflow/status/Rullst/Rullst/corpus-sync.yml?style=flat-square&label=)](https://github.com/Rullst/Rullst/actions/workflows/corpus-sync.yml) | Weekly `cargo fuzz cmin` seed corpus compaction across 33 fuzzing targets |
