...
| **`rullst-labs`** *(unpublished v13 candidate)* | Trusted bounded exercise/authorization/grading contracts, optional encrypted shared-local SQLite jobs, fenced leases/cancellation/retention and pinned controller receipts. It never executes learner code; real isolated acceptance and release admission remain outstanding. |
