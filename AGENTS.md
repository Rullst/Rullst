...
| **`rullst-privacy`** *(unpublished v13 foundation)* | Optional proportional age policies, bound challenges, signed threshold attestations, explicit decisions and replay-store contracts. Live age providers, facial models, verified guardianship, production replay storage and broader privacy workflows remain roadmap work. |
