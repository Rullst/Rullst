...
"##;
    manifest.push(("src/migrations/m20260601000000_create_lms_tables.rs", migration.to_string()));
...
"##;
    ...
    // 3. Models
    let course_model = r##"use rullst_orm::{Orm, RullstModel, sqlx::{self, FromRow}};
...
"##;
    ...
    let lesson_model = r##"use rullst_orm::{Orm, RullstModel, sqlx::{self, FromRow}};
...
"##;
    ...
    // 4. Controller
    let lms_controller = r##"use axum::{extract::Path, response::IntoResponse};
...
"##;
    manifest.push(("src/controllers/lms_controller.rs", lms_controller.to_string()));
