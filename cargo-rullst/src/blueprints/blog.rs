...
"##;
    manifest.push(("src/migrations/m20260601000000_create_posts_table.rs", migration.to_string()));
...
"##;
    manifest.push(("src/controllers/blog_controller.rs", blog_controller.to_string()));
