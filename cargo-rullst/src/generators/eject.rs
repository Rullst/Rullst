...
pub fn run_eject_project(
    ...
    println!(
        "{}",
        "🚪 Running Framework Escape Hatch (Ejecting to Pure Axum)..."
            .bright_cyan()
            .bold()
    );
    ...
    ejected.push_str(
        "// EJECTED AXUM SERVER — Pure Axum & Tokio Code without Framework Abstractions\n",
    );
    ...
    println!(
        "{}",
        format!(
            "✅ Successfully ejected project to pure Axum code at '{}'!",
            target_file
        )
        .green()
        .bold()
