...
pub(crate) async fn studio_data_handler() -> axum::response::Html<String> {
    axum::response::Html(
        r#"<!DOCTYPE html>
<html lang="en" class="h-full bg-slate-950 text-slate-100">
<head>
...
pub(crate) async fn studio_security_handler() -> axum::response::Html<String> {
...
pub(crate) async fn studio_telemetry_handler() -> axum::response::Html<String> {
    let ai_active = is_ai_configured();
...
pub(crate) async fn studio_ai_handler() -> axum::response::Html<String> {
    axum::response::Html(
        r#"<!DOCTYPE html>
<html lang="en" class="h-full bg-slate-950 text-slate-100">
<head>
...
pub(crate) async fn studio_capital_handler() -> axum::response::Html<String> {
    axum::response::Html(
        r#"<!DOCTYPE html>
<html lang="en" class="h-full bg-slate-950 text-slate-100">
<head>
...
pub(crate) async fn studio_traces_handler() -> axum::response::Html<String> {
    axum::response::Html(
        r#"<!DOCTYPE html>
<html lang="en" class="h-full bg-slate-950 text-slate-100">
<head>
