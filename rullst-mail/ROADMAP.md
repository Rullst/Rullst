...
| Bounded attachments/CID across the named REST, SES and SMTP paths | Implemented in the owned-byte contract above; provider acceptance and attachment-content inspection are not implied |
| Failover, scheduling, tenant routing, URL/DLP checks and tracking | Useful partial foundations with the named limits above |
