...
async function runTerminalAnimation() {
  ...
  const steps = [
    ...
    { type: 'output', text: '📜🦀🌐 Rullst Framework v2.0.5', delay: 300 },
    { type: 'output', text: 'The emotional productivity framework for Rust.', delay: 100 },
    { type: 'empty', delay: 200 },
    { type: 'menu', text: '? What would you like to do?', delay: 400 },
    { type: 'option', text: '❯ Scaffold a new Full-Stack Project', active: true, delay: 500 },
    { type: 'option', text: '  Generate Authentication Module', active: false, delay: 100 },
    { type: 'option', text: '  Generate Uptime Monitor Module', active: false, delay: 100 },
    { type: 'option', text: '  Dockerize existing project', active: false, delay: 100 },
    { type: 'option', text: '  Deploy via SSH pipeline (Foundry)', active: false, delay: 100 },
    { type: 'empty', delay: 800 },
    { type: 'output', text: '✔ Project "my_startup" scaffolded successfully! 🚀', color: '#10b981', delay: 400 },
