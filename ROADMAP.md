...
| :--- | :---: | :--- |
| **v12.0.0** | `[~] Stable release closeout` | Features are frozen and `12.0.0-rc.1` is public. The stable tag still requires the exact-candidate local, hosted, package and owner-approval gates; version numbers in manifests do not make a release complete. |
