...
| **M5** | DX: documentation hub, RullstPress, and AST TypeScript generation | `[~] Partial` *(worth finishing — generators exist, but generated-project and serialization contract tests are still needed; AST inference is not a complete API contract)* | v12.1 |
